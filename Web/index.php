...
require __DIR__.'/../lib/CRFram/SplClassLoader.php';

// On va ensuite enregistrer les autoloads correspondant à chaque vendor (OCFram, App, Model, etc.)
$OCFramLoader = new SplClassLoader('CRFram', __DIR__.'/../lib');
...
// $formBuilderLoader = new SplClassLoader('swiftmailer', __DIR__.'/../vendor/swiftmailer');
// $formBuilderLoader->register();
...
// if(isset($_COOKIE['enter']) && $_COOKIE['enter'] == 'sowhat') { 
