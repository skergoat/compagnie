...
<?php } else { ?>
	...
	<div class="panel-block" id="container-input-file">
		...
		<fieldset class="fieldset-input-slider" id="workshops-fieldset"> Ajoutez des images (3 minimum) : <br><br>

			<div class="fieldset-child" id="workshops-field">

				<div class="panel container-height" id="workshops-height"> 
