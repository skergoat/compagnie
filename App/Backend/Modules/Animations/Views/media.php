...
<?php } else { ?>
	...
	<div class="panel-block" id="container-input-file">
		...
		<fieldset class="fieldset-input-slider" id="animations-fieldset"> Ajoutez des images (3 minimum) : <br><br>

			<div class="fieldset-child" id="animations-field">

				<div class="panel container-height" id="animations-height"> 
